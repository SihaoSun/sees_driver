...
{ 
  ...
  {
    this->properties()->addEntry("SupportsOnChangeCallback", iness::make_shared<SimpleValue<bool>>(true,Node::RwType::READ_ONLY, false)  );
  }
}

TEMPT
Node::Ptr CSCOPE::create( T_TYPE _init_val, Node::RwType _rw_type )
{ 
  return iness::make_shared< SimpleValue<T_TYPE> >(_init_val,_rw_type);
}
