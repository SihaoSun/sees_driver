...
enum caer_special_event_types {
	...
	EXTERNAL_INPUT_RISING_EDGE_COUNT = 48,  //!< Counter for rising edge input. Can count to 63 (6bit).
        EXTERNAL_INPUT_FALLING_EDGE_COUNT = 49, //!< Counter for falling edge input. Can count to 63 (6bit).
        DATA_DROPPED = 50 //!< Data in one of the hardware FIFOs was dropped. Bit encoding: |0|TIME|EXT|IMU|APS|DVS|.
};
